...
# Needed for views, stored procs, etc...
from website.db import replaceable
    ...
    try:
        for name, rec in engines.items():
            ...
            try:
                ...
                logger.warn(f"Missing metadata for {name}, skipping.")
                continue
            context.configure(
            ...
            try:
                ...
                logger.warn(f"Missing migration function {e.args}, skipping.")
                continue
